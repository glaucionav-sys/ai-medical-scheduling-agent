...
For confidentiality, screenshots should be taken from the **sanitized imported workflow** rather
than directly from the production workflow.

Follow [`docs/SCREENSHOT_GUIDE.md`](docs/SCREENSHOT_GUIDE.md) before adding images here.
